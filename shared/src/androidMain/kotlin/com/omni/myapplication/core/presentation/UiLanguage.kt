...
actual class UiLanguage(@DrawableRes val drawableRes: Int, actual val language: Language) {

    fun toLocal(): Locale? = when (language) {
    ...
    actual companion object {
        ...
        actual val allLanguages: List<UiLanguage>
            get() = Language.values().map { language ->
                UiLanguage(language = language , drawableRes = when(language){
